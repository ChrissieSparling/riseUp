...
const Profile = () => {
    ...
    return (
        ...
        <div className="user-home">
            <h1 className="user-welcome">Hello {username}! This is the {roleName} homepage!</h1>
            ...
            <div>
                <div className="user-home-btn-box">
                    ...
                    {auth.role==='paidUser' ? <UserHome/> : 
                        auth.role==='mod' ? <ModHome/> :
                        auth.role==='admin' ? <AdminHome/> : <Navigate to='/login' state={{from: location}} replace/>}
                </div>
