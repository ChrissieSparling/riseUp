...
export function PrivacyPolicy () {
  return (
    ...
    <div className='d-flex row justify-content-center'>
      <h1 style={styles.h1} className='col-12'>WeRiseUpToday Privacy Policy</h1>
      <p style={styles.p} className='col-10'>This Privacy Policy explains how we collect, use, store, protect, and share your personal information through our services.
      </p>
      <p>If you reside in the European Economic Area (“EEA”) or United Kingdom, WeRiseUpToday Netherlands BV is the “data controller” of your personal information collected through the services (as defined in our PrivacyPolicy of Service).For everyone else, WeRiseUpToday Inc. is the data controller.
      It/'s important that you read this entire policy, but here/'s a summary to get you started:
      </p>
      <p> We care a lot about privacy. We are committed to creating spaces where people can come together and find belonging. Respecting user privacy is a key part of that mission.
      </p>
      <p>
      ...
      <p> WeRiseUpToday is your place to talk
        ...
        <br />
        Other information you provide directly to us. You may have the option to submit additional information as you use WeRiseUpToday. For example, you may choose to participate in our verified server program, which requires that you provide additional information about yourself or your company. Or, you may participate in surveys where you can provide feedback on the product, or submit information to our WeRiseUpToday Support teams.
        </p>
        <p>
        Information we collect automatically
        </p>
        <p> We also collect information automatically from you when you use WeRiseUpToday. This includes:
        <br />
        ...
        <br />
        Other information that we collect automatically. When you take certain actions on other sites, we may receive information about you. For example, when we advertise for WeRiseUpToday on third party platforms, if you click on the ad, we may receive information about which ad you saw and on which platform. Similarly, we may also receive certain information when you click on a referral link, such as which website you came from.
        <br />
        ...
        <p>
        Strictly Necessary TOKENS/cookies: 
        <br />
        These are required for services to function. If you try to use tools to disable these cookies, parts of the services may not work properly.
        <br />
        ...
        To provide you with the services. We use your information to provide you with the WeRiseUpToday services. For example, when you start a video call, we process your images and audio to make that work. We similarly collect and store the messages you send and display them as you direct. We also use the information you provide to us to create and manage your account and to facilitate purchases. When you enable optional features (like connecting your WeRiseUpToday account to other platforms), we use information from those services to power the feature (like displaying what song you are listening to on another service within the WeRiseUpToday app).
        <br />
        To meet our commitments to the WeRiseUpToday community. We work hard to try to make WeRiseUpToday a safe, positive, and inclusive place. To do so, we use your information to monitor for and take action against users and content that violate our PrivacyPolicy of Service, Community Guidelines, and other policies. This includes responding to user reports, detecting fraud and malware, and proactively scanning attachments and other content for illegal or harmful content. We also use certain information, which may include content reported to us and public posts, to develop and improve systems and models that can be automated to more swiftly detect, categorize, and take action against prohibited content or conduct.
        <br />
        To personalize the product. We use your information to provide, personalize and improve our services. This information powers our discovery surfaces (so that you see relevant communities or content first), and it helps us surface WeRiseUpToday features and promotions from us and our partners that may be of interest to you. As discussed in the “How to control your privacy” section below, you can choose whether to allow us to personalize your WeRiseUpToday experience.
        <br />
        ...
        <br />
        To protect our services. We use information to keep our services secure, to prevent misuse, and to enforce our PrivacyPolicy of Service and other policies against users who violate them.
        <br />
        ...
        <br />
        To advertise our services on other platforms. We are proud of the product we've built and spend money advertising it on other platforms in order to bring more users to WeRiseUpToday. As part of that, we use certain information to assist in the delivery of our advertising, to measure the effectiveness of advertisements for our own products, and to improve such advertisements in the future.
        <br />
        To comply with our legal obligations
        <br />
        We retain and use your information in connection with potential legal claims when necessary and for compliance, regulatory, and auditing purposes. For example, we retain information where we are required by law or if we are compelled to do so by a court order or regulatory body. Also, when you exercise any of your applicable legal rights to access, amend, or delete your personal information, we may request identification and verification documents from you for the purpose of confirming your identity. With your consent
        <br />
        ...
        <br />
        When you tell us to. When you add your content to the services, you are telling us to share that content with certain communities, people, or in the case of public spaces, with anyone who accesses it. Who can access that information is determined by who can access a particular community. Server owners or admins set those permissions, and they control whether a server requires an invite link or is open and accessible to anyone. And these permissions, like the size of the server, may change over time. Similarly, if you link your WeRiseUpToday account with a third-party service (like a music-streaming service) or participate in a server that has third-party features like bots enabled, you may be telling us to share certain information with that service, or with other WeRiseUpToday users. You can control this sharing as described in the "How to control your privacy" section below. We may also share your information as you otherwise instruct us or provide us your consent to do so.
        <br />
        With our vendors. We may share information with vendors we hire to carry out specific work for us. This includes payment processors like Stripe and PayPal that process transactions on our behalf and cloud providers like Google that host our data and our services. We may also share limited information with advertising platforms to help us reach people that we think will like our product and to measure the performance of our ads shown on those platforms. We do this to help bring more users to WeRiseUpToday, and provide only the information required to facilitate these services. This may include information like the fact that you installed our app or registered to use WeRiseUpToday.
        ...
        <br />
        To enforce our policies and rights. We may share information if needed to enforce our PrivacyPolicy of Service, Community Guidelines, or other policies, or to protect the rights, property, and safety of ourselves and others.
        <br />
        ...
        <br />
        Sale, Acquisition, or Transfer of Assets. We may share information if WeRiseUpToday is evaluating and/or engaging in a merger, acquisition, reorganization, bankruptcy, or sale, transfer, or change in ownership of WeRiseUpToday or any of its assets.
        <br />
        ...
        <br />
        We believe that users should be able to tailor their WeRiseUpToday experience to their preferences, including privacy. And while local laws may require different things, we believe that our users should have the same basic ability to shape their experience no matter where they are in the world. Here/'s how you can control how we process your information and how to request access to your information:
        <br />
        Be aware of the WeRiseUpToday spaces you choose to participate in
        <br />
        You can always choose what communities to participate in and what information you add to our services. You can choose what messages to send or post, who to engage with (e.g., one or more particular users or a potentially unlimited group of users), what information to include in your profile, whether to connect any third party services to your WeRiseUpToday account, and more. For example, if you share content in public spaces, it may be accessed by anyone. Public content may also be subject to fewer restrictions under your local laws.
        <br />
        Customize your personal WeRiseUpToday settings
        We offer a number of settings that allow you to tailor your experience within WeRiseUpToday. Some of these relate to specific features: for example, you can choose whether to display your current activity in your status via the Activity Status tab in your User Settings page (this is the gear icon next to your name).
        ...
        Restrict our ability to use your data to improve our products. If you turn off the “Use data to improve WeRiseUpToday” setting, we will stop collecting and using certain event and log information to help us understand how users use our services, what features or products they may want, or to otherwise improve our services.
        <br />
        Restrict our ability to personalize WeRiseUpToday for you. If the “Use data to customize my WeRiseUpToday experience” setting is disabled, we will stop collecting and using certain event and log information to help us offer you relevant recommendations for in-app content and features.
        <br />
        ...
        <br />
        You can edit or delete a WeRiseUpToday server if you have the permissions needed to do so.
        You can edit or delete a channel from a WeRiseUpToday server if you have the permissions needed to do so.
        Public posts may be retained by WeRiseUpToday for use as described elsewhere in this policy. Also, in limited circumstances, we may have a legal obligation to retain certain information, even if you delete the information or your account.
        <br />
        ...
        Questions or concerns about your privacy? You can email us at WeRiseUpToday@gmail.com
        <br />
        ...
        <br />
        If you have questions or complaints regarding our compliance with the Privacy Shield principles, please reach out to us at weriseuptoday@gmail.com
        <br />
        If we do not resolve your complaint, you may submit your complaint free of charge to JAMS. Under certain conditions specified by the Privacy Shield principles, you may also be able to invoke binding arbitration to resolve your complaint. We are subject to the investigatory and enforcement powers of the U.S. Federal Trade Commission. In certain circumstances, we may be liable for the transfer of personal data from the EU, Switzerland, or the UK to a third party outside those countries.
        <br />
        ...
        <br />
        We allow third party developers to build certain features or other services and offer them within the WeRiseUpToday services. For example, server administrators can add “bots” created by third party developers that provide features like content moderation and interactive games. Similarly, you may have access to games or activities built by third parties within the services.
        <br />
        These third-party services need to follow all policies that apply to them (including often our Developer PrivacyPolicy of Service and Developer Policy). As part of these policies, we require developers to have a privacy policy that makes clear what they do with your information. Please review these privacy policies, as they describe what bots and apps may do with your information. We also require that certain popular bots apply for access to certain data. But because these services are operated by third parties, we don/'t control them or what information they collect. It/'s up to you whether to participate in a server that uses bots, and whether to engage with third-party services in general.
        <br />
        </p>
        <p>
        Data Protection Officer
        <br />
        You can contact WeRiseUpToday/'s Data Protection Officer at weriseuptoday@gmail.com
        <br />
        ...
        <br />
         You can exercise your GDPR rights as described in the “How to control your privacy” section above. If you encounter a problem, reach out to us at weriseuptoday@gmail.com
         <br />
         </p>
         <p>
        ...
        Our collection and use of personal information: We collect the following categories of personal information: identifiers (such as your username, the email address you used to sign up, and your phone number if you/'ve chosen to provide it)
        <br />
        commercial information (a record of what you/'ve bought from WeRiseUpToday, if anything); financial data (payment information and your history of purchases from WeRiseUpToday); internet or other network information (how you interact with the application)
        <br />
        location information (because your IP address may indicate your general location)
        <br />
        inference data about you (for example, what content you may be interested in)
        <br />
        other information that identifies or can be reasonably associated with you. For more information about what we collect and the sources of such collection, please see the “The information we collect” section above. We collect personal information for the business and commercial purposes described in “How we use your information” above.
        <br />
        </p>
        <p>
